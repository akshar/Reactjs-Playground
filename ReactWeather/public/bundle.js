	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        Link,
	        { to: '/about', activeClassName: 'about', activeStyle: { fontWeight: 'bold' } },
	        'About'
	      ),
	      React.createElement(
	        Link,
	        { to: '/examples', activeClassName: 'examples', activeStyle: { fontWeight: 'bold' } },
	        'Examples'
	      )
	    );
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?appid=71d21edecb120cb799c3ff5923b50b99&units=imperial";
